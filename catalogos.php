...
<div id="frame"><center>
      <p>&nbsp;</p>
      <p>
        <input name="btnFin5" type="button" class="boton" id="btnFin5" onclick="MM_goToURL('parent','index.php');return document.MM_returnValue" value="Menu Principal" />
        <input name="btnFin" type="button" class="boton" id="btnFin" onclick="MM_goToURL('parent','catalogo_areas.php?show=add');return document.MM_returnValue" value="Areas de Servicio" />
        <input name="btnFin2" type="button" class="boton" id="btnFin2" onclick="MM_goToURL('parent','catalogo_ministerios.php?show=add');return document.MM_returnValue" value="Ministerios" />
        <input name="btnFin3" type="button" class="boton" id="btnFin3" onclick="MM_goToURL('parent','catalogo_cargos.php?show=add');return document.MM_returnValue" value="Cargos" />
        <input name="btnFin4" type="button" class="boton" id="btnFin4" onclick="MM_goToURL('parent','catalogo_cultos.php?show=add');return document.MM_returnValue" value="Cultos" />
      </p>
      <p>&nbsp;</p>
      <p>&nbsp;</p>
</center>
