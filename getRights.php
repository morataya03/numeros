...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO security (id_usr, carnet, contrasena, acceso) VALUES (%s, %s, %s, %s)",
...
<?php if ($totalRows_RightsCheck == "1") { ?>
  El Usuario <?php echo $_GET['carnet']; ?> ya tiene derechos dentro del sitema.<br />
¿Desea editar los privilegios que ya se otorgaron?
<label>
  <br />
  <input name="button" type="submit" class="boton" id="button" onclick="MM_goToURL('parent','getRights_edit.php?carnet=<?php echo $_GET['carnet']; ?>');return document.MM_returnValue"value="Si" />
  <input name="button2" type="submit" class="boton" id="button2" onclick="MM_goToURL('parent','search.php?show=rights');return document.MM_returnValue" value="No" />
</label>
<?php } else { ?>
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
    <table border="0" align="center" cellpadding="3" cellspacing="3">
          ...
          <tr valign="baseline">
            ...
            <label>
              <input name="contrasena" type="password" id="contrasena" size="32" />
            </label>
          ...
          <tr valign="baseline">
            ...
            <td valign="baseline"><table>
              <tr>
                <td><input type="radio" name="acceso" value="Alfa" />
                  Alfa</td>
              </tr>
              <tr>
                <td><input type="radio" name="acceso" value="Charlie" />
                  Charlie</td>
              </tr>
              <tr>
                <td><input name="acceso" type="radio" value="Delta" checked="checked" />
                  Delta</td>
              </tr>
              <tr>
                <td><input type="radio" name="acceso" value="Sierra" />
                  Sierra</td>
              </tr>
            </table></td>
          </tr>
          <tr valign="baseline">
            <td colspan="2" align="right" nowrap="nowrap"><input type="submit" class="boton" onclick="MM_goToURL('parent','search.php');return document.MM_returnValue" value="Cancelar" />              <input type="submit" class="boton" value="Otorgar Derechos" /></td>
          </tr>
        </table>
