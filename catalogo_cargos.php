...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO cat_carg (id_carg, cargo) VALUES (%s, %s)",
                       GetSQLValueString($_POST['id_carg'], "int"),
                       GetSQLValueString($_POST['cargo'], "text"));

  mysql_select_db($database_arkg, $arkg);
  $Result1 = mysql_query($insertSQL, $arkg) or die(mysql_error());

  $insertGoTo = "catalogo_cargos.php?show=add";
  #if (isset($_SERVER['QUERY_STRING'])) {
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form2")) {
  $updateSQL = sprintf("UPDATE cat_carg SET cargo=%s WHERE id_carg=%s",
                       GetSQLValueString($_POST['cargo'], "text"),
                       GetSQLValueString($_POST['id_carg'], "int"));
  ...
  $updateGoTo = "catalogo_cargos.php?show=add";
  #if (isset($_SERVER['QUERY_STRING'])) {
...
$colname_cargo_edit = "-1";
if (isset($_GET['id_carg'])) {
  $colname_cargo_edit = $_GET['id_carg'];
}
mysql_select_db($database_arkg, $arkg);
$query_cargo_edit = sprintf("SELECT * FROM cat_carg WHERE id_carg = %s", GetSQLValueString($colname_cargo_edit, "int"));
$cargo_edit = mysql_query($query_cargo_edit, $arkg) or die(mysql_error());
$row_cargo_edit = mysql_fetch_assoc($cargo_edit);
$totalRows_cargo_edit = mysql_num_rows($cargo_edit);
?>
      ...
      <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
        <table align="center">
          <tr valign="baseline">
            ...
            <td><input name="cargo" type="text" id="cargo" value="" size="32" /></td>
          </tr>
          <tr valign="baseline">
      ...
      <form action="<?php echo $editFormAction; ?>" method="post" name="form2" id="form2">
        <table align="center">
          <tr valign="baseline">
            ...
            <td><label>
              <input name="textfield" type="text" id="textfield" value="<?php echo $row_cargo_edit['id_carg']; ?>" size="32" readonly="readonly"/>
            </label>
              </td>
          </tr>
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">Cargo:</td>
            <td><input name="cargo" type="text" id="cargo" value="<?php echo htmlentities($row_cargo_edit['cargo'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
          </tr>
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">&nbsp;</td>
        ...
        <input name="id_carg" type="hidden" id="id_carg" value="<?php echo $row_cargo_edit['id_carg']; ?>" />
      </form>
      <?php }; ?>
</div>
<div class="box_right">
      <table width="387" border="0" cellpadding="3" cellspacing="3">
        <tr>
          <th width="55">ID</th>
          <th width="243" align="left">cargo</th>
          <th width="21" align="left">&nbsp;</th>
        </tr>
        <?php do { ?>
          <tr>
            <td align="center"><?php echo $row_cargo['id_carg']; ?></td>
            <td align="left"><?php echo $row_cargo['cargo']; ?></td>
            <td align="left"><a href="catalogo_cargos.php?show=edit&amp;id_carg=<?php echo $row_cargo['id_carg']; ?>"><img src="img/edit.png" alt="Editar" width="16" height="16" border="0" /></a></td>
          </tr>
