...
?>
            ...
            <span class="selectInvalidMsg">Seleccione un Area de Servicio.</span><span class="selectRequiredMsg">Este campo es Obligatorio.</span></span></td>
          </tr>
        <tr>
          <td align="right">Ministerio:</td>
          <td><span id="spryselect2">
            <select name="servicio" class="servicio" id="servicio">
              <option selected="selected" value="-1">-- Seleccione un Ministerio --</option>
            </select>
            <span class="selectInvalidMsg">Seleccione un Ministerio.</span><span class="selectRequiredMsg">Este campo es Obligatorio.</span></span></td>
          </tr>
        <tr>
...
?>
            ...
            <span class="selectInvalidMsg">Seleccione un Cargo.</span><span class="selectRequiredMsg">Este campo es Obligatorio.</span></span></td>
        </tr>
        <tr>
...
?>
            ...
            <span class="selectInvalidMsg">Seleccione un Horario.</span><span class="selectRequiredMsg">Este campo es Obligatorio.</span></span></td>
          </tr>
      </table>
